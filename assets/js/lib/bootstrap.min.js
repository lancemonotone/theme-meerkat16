...
jQuery(document).ready( function($){
	$('a.disabled').attr('title','');
	$('a.apply-tooltip:not(.disabled)').each( function(){
		if ($(this).attr('title')){
			$trigger = 'hover focus';
			//$trigger = 'click';
			$placement = 'left';
			if ( $(this).hasClass('tooltip-left')){ $placement = $placement; }
			if ( $(this).hasClass('tooltip-right')){ $placement = 'right'; }
			if ( $(this).hasClass('tooltip-bottom')){ $placement = 'bottom'; }
			if ( $(this).hasClass('tooltip-top')){ $placement = 'top'; }
